...
# simple plot bar graph based on phylum hi
```{r}
...
# create data frames for stastistical analysis 
```{r}
# extract sample information from physeq object 
samples <- sample_data(physeq)

# if samples is a phyloseq sameple_data object, convert it to a data frame 
...
```{r}
# Perfomr t/wilcox tests for each biodiversity index 
